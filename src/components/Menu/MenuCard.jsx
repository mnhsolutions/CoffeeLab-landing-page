...
export default function MenuCard({ image, title, price, category, description }) {
  return (
    <div
    ...
    >
      ...
      <footer className="grid grid-cols-[3fr_1fr] gap-2 py-2">
        <div className="product-info flex flex-col gap-2">
          <h3 className="text-[1.10rem] font-semibold leading-tight line-clamp-1">{title}</h3>
          <p className="text-sm text-gray-700 opacity-70 line-clamp-2">{description}</p>
        </div>
